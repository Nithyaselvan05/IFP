...
public class getWhatESPsays {
    private static Context context;

    public getWhatESPsays(Context context) {
...
public interface VolleyResponseListener {
   ...
   // public void getESPData(VolleyResponseListener volleyResponseListener) {
        public void getESPData(final VolleyResponseListener volleyResponseListener) {
        int ESPRes =0;
